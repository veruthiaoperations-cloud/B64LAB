...
class HexViewer:
    ...
    Offset (00000000) | Hex representation (16 bytes) | ASCII representation
    """

    @classmethod
    def render(cls, data: bytes, max_bytes: int = 256, color: bool = True) -> str:
        """Formats bytes into a canonical hex dump string."""
        if not data:
